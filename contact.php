	...
	<div id="colorlib-page">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="index.html">Fnplus</a>
						</div>
						...
						<div class="row">
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									<li><span><i class="icon-map5"></i></span>A-6,Industrial Estate,Mogappair West, Chennai, Tamil Nadu 600037</li>
									<li><span><i class="icon-phone4"></i></span>9962892900 | 9962418361</li>
									<li><span><i class="icon-envelope2"></i></span><a href="#">support@fnplus.xyz</a></li>
		...
		<div id="colorlib-subscribe">
			...
			<div class="container">
             ...
             <iframe class="airtable-embed" src="https://airtable.com/embed/shrd9NsS0RJ5mkfP5?backgroundColor=green" frameborder="0" onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe>
		</div>
			...
			<div id="footer">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-4 col-pb-sm text-center">
							<h2>Get in Touch</h2>
							<p><a href="mailto:support@fnplus.xyz">support@fnplus.xyz</a></p>
						</div>
						<div class="col-md-4 col-pb-sm text-center">
							<h2>Social</h2>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							<p>
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="icon-heart" aria-hidden="true"></i> by Fnplus & <a href="https://colorlib.com" target="_blank">Colorlib</a> 
